...
work_days <- c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday")
...
# 31.)
# Combining the two matrices from #30 to create the matrix shown below
matrix_1 <- matrix(1:6, 3, 2)
matrix_2 <- matrix(7:12, 3, 2)
