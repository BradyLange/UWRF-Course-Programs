...
public class programOne { //start of public class
	...
	public static void main(String [] args) { //start of main method
		...
		while (ask.equalsIgnoreCase(cont)) 
		{ //beginning of while loop //using IgnoreCase so an error wont occur from the user typing it in with differnet cases
	...
	public static double getBilling(double val1, double val2, double val3, double bill) 
	{ //start of getBilling method
	...
	public static void getOutput(double val1, double val2, double val3, double val4) 
